...
if (WIN32)
    ...
    set(QT_INSTALL_DIR ${SM_3RDPARTY_INSTALL_DIR}/Qt5.12.1/msvc2017_64)
elseif (APPLE)
    set(QT_PROJ_NAME Qt5_12_1)
    ...
    set(QT_INSTALL_DIR ${SM_3RDPARTY_INSTALL_DIR}/Qt5.12.1)
endif (WIN32)

file(REMOVE_RECURSE
    ${SM_3RDPARTY_BUILD_DIR}/Stamp/${QT_PROJ_NAME}
    ${SM_3RDPARTY_BUILD_DIR}/tmp/${QT_PROJ_NAME}
)
...
ExternalProject_Add(
    ...
    DOWNLOAD_DIR ${SM_DOWNLOAD_CACHE_DIR}/Download/${QT_PROJ_NAME}
    SOURCE_DIR ${SM_DOWNLOAD_CACHE_DIR}/Source/${QT_PROJ_NAME}
